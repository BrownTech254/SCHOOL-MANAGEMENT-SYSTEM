...
class AdminPersonalDataForm(forms.ModelForm):
...
class AdminFamilyInformationForm(forms.ModelForm):
	...
	class Meta:
		model = Admin_Family_Information
		#fields = '__all__'
		exclude = ['admin']

class AdminResidenceForm(forms.ModelForm):
	...
	class Meta:
		model = Admin_Residence
		#fields = '__all__'
		exclude = ['admin']


class AdminEmergencyContactPersonsForm(forms.ModelForm):
	...
	class Meta:
		model = Admin_Emergency_Contact_Persons
		#fields = '__all__'
		exclude = ['admin']
...
class AcademicBackgroundForm(forms.ModelForm):
	...
	class Meta:
		...
		#fields = ['Admin', 'name_of_secondary_school', 'index_number_of_secondary_school', 'year_of_completion_of_secondary_school', 'name_of_primary_school']
		exclude = ['admin']

# Generated by Django 5.2.4 on 2025-07-23 18:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_of_completion_of_secondary_school', models.IntegerField(blank=True, null=True)),
                ...
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='academic_data', to='admins.admin')),
            ],
        ),
        migrations.CreateModel(
            name='Admin_Emergency_Contact_Persons',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='emergency_contacts', to='admins.admin')),
            ],
        ),
        migrations.CreateModel(
            name='Admin_Family_Information',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='family', to='admins.admin')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='personal_data', to='admins.admin')),
            ],
        ),
        migrations.CreateModel(
            name='Admin_Residence',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='residence', to='admins.admin')),
            ],
        ),
    ]

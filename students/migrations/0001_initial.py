    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_number_of_secondary_school', models.IntegerField(blank=True, null=True)),
                ...
                ('index_number_of_primary_school', models.IntegerField(blank=True, null=True)),
                ('year_of_completion_of_primary_school', models.DateField(blank=True, null=True)),
                ...
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student_academic_data', to='students.student')),
            ],
        ),
        migrations.CreateModel(
            name='Student_Emergency_Contact_Persons',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('postal_box_a', models.IntegerField(blank=True, null=True)),
                ...
                ('postal_box_b', models.IntegerField(blank=True, null=True)),
                ...
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student_emmergency_contacts', to='students.student')),
            ],
        ),
        migrations.CreateModel(
            name='Student_Family_Information',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('number_of_brothers_and_sisters', models.IntegerField(blank=True, null=True)),
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student_family', to='students.student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_children_if_married', models.IntegerField(blank=True, null=True)),
                ...
                ('postal_box', models.IntegerField(blank=True, null=True)),
                ...
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='personal_data', to='students.student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student_residence', to='students.student')),
            ],
        ),
    ]

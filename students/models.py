...
from . countries import NATIONALITY_CHOICES
from .counties import COUNTY_CHOICES
from phonenumber_field.modelfields import PhoneNumberField
from accounts.models import CustomeUser
from courses.models import CourseLevel, Course
...
class Student(models.Model):
	user = models.OneToOneField(CustomeUser, on_delete=models.CASCADE, related_name='student')
	course = models.ForeignKey(Course, on_delete=models.SET_NULL, blank=True, null=True)
	level = models.ForeignKey(CourseLevel, on_delete=models.SET_NULL, blank=True, null=True)
...
class Student_Personal_Data(models.Model):
	student = models.OneToOneField(Student, on_delete=models.CASCADE, related_name='personal_data')
	first_name = models.CharField(max_length=255, null=True,blank=True)
	last_name = models.CharField(max_length=255, null=True,blank=True)
...
class Student_Family_Information(models.Model):
	student = models.OneToOneField(Student, on_delete=models.CASCADE, related_name='student_family')
...
class Student_Residence(models.Model):
	student = models.OneToOneField(Student, on_delete=models.CASCADE, related_name='student_residence')
...
class Student_Emergency_Contact_Persons(models.Model):
	student = models.OneToOneField(Student, on_delete=models.CASCADE, related_name='student_emmergency_contacts')
...
class Academic_Background(models.Model):
	student = models.OneToOneField(Student, on_delete=models.CASCADE, related_name='student_academic_data')
	...
	year_of_completion_of_secondary_school = models.DateField(null=True, blank=True)
